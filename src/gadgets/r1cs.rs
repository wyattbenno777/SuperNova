...
/// START SUPERNOVA PORTION
/// An Allocated R1CS Instance
#[derive(Clone)]
pub struct AllocatedR1CSInstanceSuperNova<G: Group> {
  pub(crate) W: AllocatedPoint<G>,
  pub(crate) X0: AllocatedNum<G::Base>,
  pub(crate) X1: AllocatedNum<G::Base>,
...
impl<G: Group> AllocatedR1CSInstanceSuperNova<G> {
  ...
  pub fn alloc<CS: ConstraintSystem<<G as Group>::Base>>(
    ...
    Ok(AllocatedR1CSInstanceSuperNova { W, X0, X1, X2 })
  }
...
pub struct AllocatedRelaxedR1CSInstanceSuperNova<G: Group> {
  pub(crate) W: AllocatedPoint<G>,
  pub(crate) E: AllocatedPoint<G>,
  pub(crate) u: AllocatedNum<G::Base>,
  pub(crate) X0: BigNat<G::Base>,
...
impl<G: Group> AllocatedRelaxedR1CSInstanceSuperNova<G> {
  ...
  pub fn alloc<CS: ConstraintSystem<<G as Group>::Base>>(
    ...
    Ok(AllocatedRelaxedR1CSInstanceSuperNova { W, E, u, X0, X1, X2 })
  }
  ...
  pub fn from_r1cs_instance<CS: ConstraintSystem<<G as Group>::Base>>(
    mut cs: CS,
    inst: AllocatedR1CSInstanceSuperNova<G>,
    limb_width: usize,
    n_limbs: usize,
  ) -> Result<Self, SynthesisError> {
    let E = AllocatedPoint::default(cs.namespace(|| "allocate W"))?;
